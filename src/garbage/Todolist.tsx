      ...
      {filteredTasks.map((task: TaskType) => {
        ...
        return (
          <li key={task.id} className={taskClass}>
            ...
            <IconButton onClick={onClickRemoveTaskHandler} aria-label="delete" size="small">
  ...
  return (
    <div>
      <h3>
        ...
        <IconButton onClick={onClickRemoveTodoListHandler} aria-label="delete" size="medium">
          <Delete fontSize="inherit" />
        </IconButton>
      </h3>
      ...
      <div>
        <Button variant={filter === "all" ? "contained" : "outlined"} color="primary" onClick={onClickSetAllFilterHandler}>
          All
        </Button>
        <Button
